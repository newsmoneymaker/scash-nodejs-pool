/**
 * Payment processor for Scash (adapted from cryptonote-nodejs-pool, GPL-2.0).
 *
 * Scash payouts are ordinary wallet transactions (SegWit address to SegWit address): all miners that are due are paid in ONE
